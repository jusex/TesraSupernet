...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"control", "getinfo", &getinfo, true, false, false}, 
        ...
        {"rawtransactions", "signrawtransaction", &signrawtransaction, false, false, false}, 
...
#ifdef ENABLE_WALLET
        {"tesra", "obfuscation", &obfuscation, false, false, true}, 
...
void StartRPCThreads()
{
    ...
    if (mapArgs["-rpcpassword"] == "") {
        ...
        if (!GenerateAuthCookie(&strRPCUserColonPass)) {
            uiInterface.ThreadSafeMessageBox(
                _("Error: A fatal internal error occured, see debug.log for details"), 
                "", CClientUIInterface::MSG_ERROR);
            StartShutdown();
            return;
        }
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http:
}
