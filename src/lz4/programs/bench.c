...
#define NBSECONDS             3
#define TIMELOOP_MICROSEC     1*1000000ULL 
#define TIMELOOP_NANOSEC      1*1000000000ULL 
#define ACTIVEPERIOD_MICROSEC 70*1000000ULL 
#define COOLPERIOD_SEC        10
#define DECOMP_MULT           1 
...
{
    size_t const blockSize = (g_blockSize>=32 ? g_blockSize : srcSize) + (!srcSize)  ;
    U32 const maxNbBlocks = (U32) ((srcSize + (blockSize-1)) / blockSize) + nbFiles;
    blockParam_t* const blockTable = (blockParam_t*) malloc(maxNbBlocks * sizeof(blockParam_t));
    size_t const maxCompressedSize = LZ4_compressBound((int)srcSize) + (maxNbBlocks * 1024);   
    ...
    {   U64 fastestC = (U64)(-1LL), fastestD = (U64)(-1LL);
        ...
        U32 nbCompressionLoops = (U32)((5 MB) / (srcSize+1)) + 1;  
        U32 nbDecodeLoops = (U32)((200 MB) / (srcSize+1)) + 1;  
...
#       define NB_MARKS 4
        ...
        while (!cCompleted || !dCompleted) {
            ...
            if (!cCompleted) memset(compressedBuffer, 0xE5, maxCompressedSize);  
            ...
            if (!cCompleted) {   
                ...
                {   U64 const clockSpan = UTIL_clockSpanNano(clockStart);
                    if (clockSpan > 0) {
                        ...
                        assert(nbCompressionLoops < 40000000);   
            ...
            (void)fastestD; (void)crcOrig;   
#if 1
            
            if (!dCompleted) memset(resultBuffer, 0xD6, srcSize);  
