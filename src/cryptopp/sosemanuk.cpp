...
#define	SSE2_uvStart		SSE2_stateCopy + 12*4
		...
		AS2(	and		esp, -16)
		AS2(	sub		esp, 80*4*2+12*4+8*WORD_SZ)	
		...
		AS2(	movdqa	xmm0, [WORD_REG(ax)+0*16])		
