...
void CCM_Base::UncheckedSpecifyDataLengths(lword headerLength, lword messageLength, lword )
{
	if (m_state != State_IVSet)
	...
	cbcBuffer[0] = byte(64*(headerLength>0) + 8*((m_digestSize-2)/2) + (m_L-1));	
