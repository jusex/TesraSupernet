...
There is apparently an issue when used on Samsung (and perhaps Android in general) devices. See [this issue](https:
...
If required, my GPG key can be found at: https:
