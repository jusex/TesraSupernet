...
enum eExtendDataType {
    EXT_DATA_STRING     = 0x00,     
    EXT_DATA_DOUBLE     = 0x01,     
    EXT_DATA_BOOL       = 0x02,     
    EXT_DATA_INT8       = 0x03,     
    EXT_DATA_UINT8      = 0x04,     
    EXT_DATA_INT16      = 0x05,     
    EXT_DATA_UINT16     = 0x06,     
    EXT_DATA_INT32      = 0x07,     
    EXT_DATA_UINT32     = 0x08,     
    EXT_DATA_INT64      = 0x09,     
    EXT_DATA_UINT64     = 0x0a,     
    EXT_DATA_INT128     = 0x0b,     
    EXT_DATA_UINT128    = 0x0c,     
    EXT_DATA_INT256     = 0x0d,     
    EXT_DATA_UINT256    = 0x0e,     
    EXT_DATA_RESERVED   = 0x0f,     
};
