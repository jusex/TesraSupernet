...
In order to support loading of multiple wallets in tesra-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is tesra.cpp.
...
Changes to tesra.cpp
----------------------
tesra.cpp is the entry point into tesra-qt, and as such, will require some minor modifications to provide hooks for
