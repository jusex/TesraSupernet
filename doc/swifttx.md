...
This mechanism has been integrated into Bitcore-Node-TESRA which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/TESRA-Project/insight-api-tesra#web-socket-api](https://github.com/TESRA-Project/insight-api-tesra#web-socket-api) 
* API: [https://github.com/TESRA-Project/insight-api-tesra#swifttx-transactions](https://github.com/TESRA-Project/insight-api-tesra#swifttx-transactions) 
...
By default, the TESRA Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the TESRA Core daemon:
