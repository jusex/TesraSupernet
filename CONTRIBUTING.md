Contributing to TESRA Core
============================

The TESRA Core project operates an open contributor model where anyone is
...
The following applies to code changes to the TESRA Core project, and is not to be
confused with overall TESRA Network Protocol consensus changes.

Whether a pull request is merged into TESRA Core rests with the project merge
...
Patches that change TESRA consensus rules are considerably more involved than
...
Where a patch set proposes to change the TESRA consensus, it must have been
...
The project leader is the release manager for each TESRA Core release.
