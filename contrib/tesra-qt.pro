...
RESOURCES += src/qt/tesra.qrc src/qt/tesra_locale.qrc

TRANSLATIONS += src/qt/locale/tesra_bg.ts \
                src/qt/locale/tesra_de.ts \
                src/qt/locale/tesra_en.ts \
                src/qt/locale/tesra_es.ts \
                src/qt/locale/tesra_fi.ts \
                src/qt/locale/tesra_fr.ts \
                src/qt/locale/tesra_it.ts \
                src/qt/locale/tesra_ja.ts \
                src/qt/locale/tesra_pl.ts \
                src/qt/locale/tesra_pt.ts \
                src/qt/locale/tesra_ru.ts \
                src/qt/locale/tesra_sk.ts \
                src/qt/locale/tesra_sv.ts \
                src/qt/locale/tesra_vi.ts \
                src/qt/locale/tesra_zh_CN.ts \
                src/qt/locale/tesra_zh_TW.ts
